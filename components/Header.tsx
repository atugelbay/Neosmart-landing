    ...
    <header className="sticky top-0 z-50 bg-transparent">
      <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 py-3 md:py-4">
        <div className="flex justify-between items-center pb-3 md:pb-4">
          ...
          {/* Desktop Navigation */}
          <nav className="hidden md:flex items-center space-x-6 lg:space-x-8 text-[#A0A7B4]" aria-label="Основная навигация">
            ...
            <Link to="/guides" className="hover:text-white transition-colors whitespace-nowrap flex items-center gap-1.5" aria-label="Видео-гайды">
